  ...
  const [studentData, setStudentData] = useState([
    {
      ...
      classes: [
        { name: 'Discrete Structures', status: 'sleeping', time: '08:30 AM' },
        { name: 'PSPF', status: 'late', time: '10:00 AM' },
        { name: 'Web Tech', status: 'bunking', time: '11:30 AM' },
        { name: 'Web Tech Lab', status: 'shouting', time: '02:00 PM' },
    ...
    },
    {
      ...
      date: 'January 29, 2025',
      classes: [
        { name: 'Discrete Structures', status: 'lauging', time: '08:30 AM' },
        { name: 'PSPF', status: 'eating', time: '10:00 AM' },
        { name: 'Web Tech', status: 'late', time: '11:30 AM' },
        { name: 'Web Tech Lab', status: 'sleeping', time: '02:00 PM' },
        { name: 'Functional English', status: 'running', time: '03:30 PM' }
      ],
